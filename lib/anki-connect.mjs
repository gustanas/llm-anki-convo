...
const READ_ACTIONS = new Set(['version', 'deckNames', 'findCards', 'cardsInfo', 'retrieveMediaFile']);
...
export function createAnkiConnect({
  ...
  async function invoke(action, params = {}) {
    if (!READ_ACTIONS.has(action)) throw new AnkiConnectError('This Anki client allows read-only actions only.', 'READ_ONLY');
